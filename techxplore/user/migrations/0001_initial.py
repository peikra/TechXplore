    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='utilities', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.loan')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='agreements', to=settings.AUTH_USER_MODEL)),
                ('utility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.utility')),
            ],
        ),
        migrations.CreateModel(
            name='Invitation',
            fields=[
                ...
                ('receiver', models.ManyToManyField(related_name='received_invitations', to=settings.AUTH_USER_MODEL)),
